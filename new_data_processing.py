...
def data_processing(run_params: RunParams, radar_window : RadarDataWindow):
    ...
    if plot_config.plot_raw_fd_heatmap:
        plotter_3 = RadarFrequencyHeatMap(max_distance=max_distance_plotted)
        plotter_3.show()
        
    if plot_config.plot_fd_detections:
        plotter_4 = RadarFrequencyHeatMap(max_distance=max_distance_plotted)
        plotter_4.show()
